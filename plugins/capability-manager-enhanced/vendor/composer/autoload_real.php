...
class ComposerAutoloaderInit32a3d3886cf8ef146352508e41da4ee9
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit32a3d3886cf8ef146352508e41da4ee9::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire32a3d3886cf8ef146352508e41da4ee9($fileIdentifier, $file);
        }
